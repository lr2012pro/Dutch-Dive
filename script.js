...
<body onload="startNewTask()">
    <div class="container">
        ...
        <div class="section">
            ...
            <p id="task-description">Klik op de knop om een nieuwe werkwoords- of grammaticataak te starten.</p>
            <div id="task-content">
                </div>
        ...
        <div class="section">
            ...
            <div class="shop-item">
                <div>
                    <h3>Digitale Badge "Grammatica Expert" 🖋️</h3>
                    <p>Kosten: 5 punten</p>
                </div>
...
function checkCurrentTask() {
    ...
    if (pointDoublerActive) {
        pointsEarned = pointsEarned * 2;
        alert(`Puntendubbelaar actief! Je verdiende punten zijn verdubbeld. Totaal verdiend: ${pointsEarned} punten.`);
    }
...
function buyItem(item, cost) {
    if (points >= cost) {
        ...
        if (item === 'badge' && !badgeUnlocked) {
            ...
            document.getElementById('joke-content').style.display = 'block';
            document.getElementById('buy-joke-btn').disabled = true;
        } else if (item === 'doubler' && !pointDoublerActive) {
            pointDoublerActive = true;
            document.getElementById('doubler-status').textContent = '✅ Actief!';
            document.getElementById('buy-doubler-btn').disabled = true;
            alert("De punten-verdubbelaar is geactiveerd! Je verdient nu twee keer zoveel punten.");
        }
    } else {
        alert(`❌ Je hebt niet genoeg punten! Je hebt ${points} punten, en je hebt ${cost} punten nodig.`);
    }
